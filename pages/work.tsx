      ...
      <div className="fade-in text-center pt-20 relative pb-8 sm:mx-auto sm:px-1 sm:max-w-xl">
        ...
        <div className="px-4 pt-6 sm:px-0 transition ease-in-out">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 content-center">
            ...
            <Link href="../works/busschedule">
              <a>
                <div className="flex-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  <Image
                    src="/assets/busschedule.png"
                    width={275}
                    height={170}
                    layout={"responsive"}
                    className="rounded-xl"
                    alt="Bus Schedule Application"
                  />
                  <article className="prose pt-8">
                    ...
                    <p className="text-left indent-2 text-sm dark:text-white">
                      An application to view and manage bus schedules, providing
                      real-time updates and route information. Built with React
                      Native and Node.js.
                    </p>
                  </article>
                </div>
            ...
            {/* Cryptocurrency Rate Application */}
            <Link href="../works/cryptocurrency">
              <a>
                <div className="flex-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  <Image
                    ...
                    layout={"responsive"}
                    className="rounded-xl"
                    alt="Cryptocurrency Rate Application"
                  />
                  <article className="prose pt-8">
                    <h1 className="text-base dark:text-white">
                      Cryptocurrency Rate Application
                    ...
                    <p className="text-left indent-2 text-sm dark:text-white">
                      A mobile application to track real-time cryptocurrency
                      exchange rates and trends. Developed with Flutter and
                      Firebase.
                    </p>
                  </article>
                </div>
            ...
            <Link href="../works/powertalent">
              <a>
                <div className="flex-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  <Image
                    src="/assets/powertalent.png"
                    width={275}
                    height={170}
                    layout={"responsive"}
                    className="rounded-xl"
                    alt="Power Talent Bounty Hunter Application"
                  />
                  <article className="prose pt-8">
                    <h1 className="text-base dark:text-white">
                      Power Talent Bounty Hunter Application
                    ...
                    <p className="text-left indent-2 text-sm dark:text-white">
                      A talent-matching platform for bounty hunting projects,
                      connecting freelancers with clients. Built with React,
                      Node.js, and MongoDB.
                    </p>
                  </article>
                </div>
            ...
            <Link href="../works/wqdb">
              <a>
                <div className="felx-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  ...
                  <article className="prose pt-8">
                    <h1 className="text-base dark:text-white">
                      WaterQuality Predition Website
                    </h1>
                    <p className="text-left indent-2 text-sm dark:text-white">
                      Website that can Predict WaterQuality value such as PH
                      Salinity ..etc this website run on FastAPI framework and
                      use Machine Learning model to predict and use Next.js for
                      Front end
                    </p>
                  </article>
                </div>
            ...
            <Link href="../works/dashboard">
              <a>
                <div className="felx-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  ...
                  <article className="prose pt-8">
                    <h1 className="text-base dark:text-white">
                      Student enroll management Website
                    </h1>
                    <p className="text-left indent-2 text-sm dark:text-white">
                      Website that can manage student enroll and Grade in the
                      university made with next.js and LumenAPI
                    </p>
                  </article>
                </div>
              </a>
              ...
              <a>
                <div className="felx-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  ...
                  <article className="prose pt-8">
                    ...
                    <p className="text-left indent-2 text-sm dark:text-white">
                      A chat application that can send message made with React
                      and Firebase
                    </p>
                  </article>
                </div>
              ...
              <a>
                <div className="felx-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  ...
                  <article className="prose pt-8">
                    ...
                    <p className="text-left indent-2 text-sm dark:text-white">
                      A ShopManagement application that will store you items
                      into Database and can add,edit or delete item from
                      database
                    </p>
                  </article>
                </div>
              ...
              <a>
                <div className="felx-col hover:-translate-y-1 hover:scale-105 ease-in-out delay-150 duration-300">
                  ...
                  <article className="prose pt-8">
                    ...
                    <p className="text-left indent-2 text-sm dark:text-white">
                      A Line-Chatbot made with Node.js integrate with Line
                      Message-API
                    </p>
                  </article>
                </div>
