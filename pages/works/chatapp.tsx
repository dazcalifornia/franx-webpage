...
export default function chatapp() {
  return (
    <div className="relative flex flex-col min-h-screen justify-center bg-main dark:bg-darkMain py-6 sm:py-12">
      <Head>
        <title>Supakit Wiwustrinon -{">"} ChatApp</title>
        ...
        <div className="px-4 pt-4 sm:px-0">
          <div className="relative pb-4 sm:max-w-lg">
            <span className="flex content-start items-center">
              ...
              <p className="pl-2 dark:text-white">{">"} Chatapp</p>
            </span>
          </div>
          {/* information */}
          <article className="prose pt-8">
            <p className="text-left indent-4 md:px-4 text-base dark:text-white break-words">
              This is a Chat application that make with java and run on Android
              integrate with RealtimeDB feature in this appp is create room
              customize Username
            </p>
          </article>
          <div className="text-left pt-4 ">
            <span className="flex content-start items-center">
              ...
              <Link href="https://github.com/dazcalifornia/chat">
                <div className="pl-3 ">
                  <p className="hover:bg-emerald-400/20 cursor-pointer p-1 rounded-md duration-300 no-underline hover:underline dark:text-white">
                    https://github.com/dazcalifornia/chat
                  </p>
                </div>
              </Link>
            </span>
